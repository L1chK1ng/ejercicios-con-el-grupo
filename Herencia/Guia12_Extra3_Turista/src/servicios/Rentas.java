...
public class Rentas {
    ...
    public ArrayList<Alojamiento> hotelDisponible() {
        ...
        Alojamiento hotel1 = new Hotel4Estrellas("Burro con sueño", "Calle 1", "Barrio antigüo", "Manolo", 40, 70, 10, 50d, false, null, "Glotoneria", 150);
        listaAlojamientos.add(hotel1);
        Alojamiento hotel2 = new Hotel4Estrellas("A dormir", "Calle 4", "Barrio viejo", "Juancito", 80, 140, 20, 50d, true, "Tipo B", "Muertos de hambre", 300);
    ...
    public void menuAlojamiento(ArrayList<Alojamiento> lista) {
        ...
        for (Alojamiento aux : lista) {
            ...
            if (aux instanceof Hotel4Estrellas) {
                System.out.println("Hotel 4 estrellas " + i);
            ...
            } else if (aux instanceof Hotel5Estrellas) {
                System.out.println(separador);
                    System.out.println("Hotel 5 estrellas " + j);
                    System.out.println("Nombre: " + aux.getNombre());
                    System.out.println("Direccion: " + aux.getDireccion() + ", " + aux.getLocalidad());
                    System.out.println("Gerente encargado: " + aux.getGerenteEnc());
